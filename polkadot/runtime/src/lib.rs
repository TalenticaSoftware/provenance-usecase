...
/// Configure the registrar pallet in pallets/registrar.
impl registrar::Config for Runtime {
	type Event = Event;
}

/// Configure the bottle-tracking pallet in pallets/bottle-tracking.
impl bottle_tracking::Config for Runtime {
	type Event = Event;
}
